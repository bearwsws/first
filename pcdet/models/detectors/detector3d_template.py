...
class Detector3DTemplate(nn.Module):
    ...
    def build_networks(self):
        model_info_dict = {
         ...
         #   'depth_downsample_factor': self.dataset.depth_downsample_factor vod去掉
        }
    ...
    def build_vfe(self, model_info_dict):
        ...
        vfe_module = vfe.__all__[self.model_cfg.VFE.NAME](
            ...
            #grid_size=model_info_dict['grid_size'],  vod数据集修改
          #  depth_downsample_factor=model_info_dict['depth_downsample_factor'] vod去掉
        )
